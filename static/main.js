...
(function(exports) {
  ...
  var showError = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 73, column 3 - line 74, column 3: " + [ v.constructor.name ]);
  });
  ...
  var fiStrName = function ($102) {
      return fnGetName(fiGetName($102));
  };
  var fiGetAddrs = function (v) {
      return v.addrs;
  };
  var isValid = function ($103) {
      return !Data_Array["null"](fiGetAddrs($103));
  };
  ...
  var depositWei = function (w) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
          ...
          throw new Error("Failed pattern match at Network.Eth.Foundation line 227, column 3 - line 229, column 126: " + [ v.constructor.name ]);
      });
  };
  var expirationDate = (function () {
      ...
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
          ...
          throw new Error("Failed pattern match at Network.Eth.Foundation line 265, column 3 - line 269, column 32: " + [ v.constructor.name ]);
      });
  })();
  var extendIdOneYear = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(Network_Eth.weiStr)(getWeiToExtend))(function (v1) {
          ...
          throw new Error("Failed pattern match at Network.Eth.Foundation line 256, column 3 - line 260, column 27: " + [ v.constructor.name ]);
      });
  });
  var getDepositWei = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      if (v instanceof Data_Maybe.Just) {
          return Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(function ($104) {
              return Data_Maybe.Just.create(Network_Eth.mkWei($104));
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 243, column 3 - line 246, column 69: " + [ v.constructor.name ]);
  });
  var sentPending = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 193, column 3 - line 197, column 93: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var Network_Eth = PS["Network.Eth"];
  var Network_Eth_Foundation = PS["Network.Eth.Foundation"];        
  var hasNetworkError = function ($11) {
      return !Data_Array["null"](Data_Array.filter(Network_Eth.hasError)($11));
  };
                      ...
                      return function (affCall) {
                          ...
                          if (errorBus instanceof Data_Maybe.Just) {
                              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_Foundation.runMonadF(affCall)))(function (v) {
                                  if (v instanceof Data_Either.Left) {
                                      return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Control_Monad_Aff_Bus.write(new Foundation_Types.FoundationError(v.value0))(errorBus.value0)))(function (v1) {
                                          return Control_Applicative.pure((dictMonadEff.Monad0()).Applicative0())(blankVal);
                                      });
                                  };
                                  if (v instanceof Data_Either.Right) {
                                  ...
                                  throw new Error("Failed pattern match at Foundation.Blockchain line 21, column 7 - line 24, column 30: " + [ v.constructor.name ]);
                              });
                          };
                          throw new Error("Failed pattern match at Foundation.Blockchain line 15, column 3 - line 24, column 30: " + [ errorBus.constructor.name ]);
                      };
                  };
              };
          };
...
(function(exports) {
                  ...
                  return function (myId) {
                      return Control_Bind.bind(dictBind)(Control_Monad_State_Class.gets(dictMonadState)(function (v) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Monad_State_Class.modify(dictMonadState)(function (v1) {
                              ...
                              return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleFCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Data_Maybe.Nothing.value)(Network_Eth_Foundation.sentPending))(function (v1) {
                                  return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleFCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Data_Maybe.Nothing.value)(Network_Eth_Foundation.todoPending))(function (v2) {
                                      return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleFCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Data_Maybe.Nothing.value)(Network_Eth_Foundation.expirationDate))(function (v3) {
                                          return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleFCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Data_Maybe.Nothing.value)(Network_Eth_Foundation.getDepositWei))(function (v4) {
                                              return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleFCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Network_Eth.zeroWei)(Network_Eth_Foundation.getWeiToExtend))(function (v5) {
      ...
      return function (dictMonadAff) {
          return function (f) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleFCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(v.errorBus)(Network_Eth.blankTx)(f))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(watchTx(v1))(function () {
                          return Halogen_Query_HalogenM.raise(new ScreenChange(Foundation_Routes.OverviewScreen.value));
                      });
                  });
              });
          };
  ...
  var formatDate = function ($98) {
      return Data_Either.either(Data_Function["const"](""))(Control_Category.id(Control_Category.categoryFn))(Data_Formatter_DateTime.formatDateTime("YYYY-MM-DD")($98));
  };
  ...
  var extendIdPage = function (expiryDate) {
      return function (weiToExtend) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col extend-id-page") ])([ card("Expires")(Halogen_HTML_Core.text(Data_Maybe.maybe("")(formatDate)(expiryDate))), card("Extend for 1 Year")(Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ExtendId.create)), Halogen_HTML_Properties.class_("btn btn-secondary") ])([ Halogen_HTML_Core.text("Extend for " + (Network_Eth.weiShowEth(weiToExtend) + " ETH")) ])) ]);
      };
  };
  var fundsPage = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col funds-page") ])([ card("Balance")(Halogen_HTML_Core.text(Data_Maybe.maybe("")(Data_Show.show(Network_Eth.showWei))(state.funds) + " Wei")), card("Deposit: " + (Network_Eth.weiShowEth(state.fundAmountWei) + " Eth"))(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_(""), Halogen_HTML_Properties.placeholder("Enter wei to deposit here"), Halogen_HTML_Properties.value(Network_Eth.weiStr(state.fundAmountWei)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
          return InputFundAmount.create(val);
      })) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(FundId.create(state.fundAmountWei))), Halogen_HTML_Properties.class_("btn btn-secondary") ])([ Halogen_HTML_Core.text("Deposit ETH") ]) ])) ]);
  };
              ...
              return function (addressCount) {
                  return function (funds) {
                      ...
                      if (optionalID instanceof Data_Maybe.Nothing) {
                          ...
                          throw new Error("Failed pattern match at Foundation.Manager line 178, column 7 - line 190, column 14: " + [ pendingConfirmation.constructor.name ]);
                      };
                      ...
                      throw new Error("Failed pattern match at Foundation.Manager line 176, column 6 - line 199, column 10: " + [ optionalID.constructor.name ]);
                  };
              };
          };
      };
  ...
  var addAddressPage = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col add-address-page") ])([ card("Link a new address to " + Data_Maybe.maybe("")(function ($99) {
          return Data_Show.show(Network_Eth_Foundation.showFoundationName)(Network_Eth_Foundation.fiGetName($99));
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main-view") ])([ page(Foundation_Routes.OverviewScreen.value)(summary(state.todoPending)(state.myId)(state.expiryDate)(Data_Array.length(state.addresses))(state.funds)), page(Foundation_Routes.ManageAddressesScreen.value)(addressesPage(state.addresses)(state.sentPending)(state.todoPending)), page(Foundation_Routes.AddAddressScreen.value)(addAddressPage(state)), page(Foundation_Routes.RegisterScreen.value)(createIdPage(state)), page(Foundation_Routes.ExtendIDScreen.value)(extendIdPage(state.expiryDate)(state.weiToExtend)), page(Foundation_Routes.FundIDScreen.value)(fundsPage(state)) ]);
      };
      ...
      var $$eval = function (v) {
          if (v instanceof HandleInput) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $48.errorBus = v.value0.msgBus;
                  $48.myId = v.value0.myId;
                  return $48;
              }))(function () {
          ...
          if (v instanceof ConfirmUnification) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(Network_Eth_Foundation.confirmPendingUnification(v.value0)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          ...
          if (v instanceof AddNewAddress) {
              ...
              if (v.value0 instanceof Data_Either.Right) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $71.newAddress = new Data_Either.Left("");
                      return $71;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(Network_Eth_Foundation.addPendingUnification(v.value0.value0)))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              };
              throw new Error("Failed pattern match at Foundation.Manager line 119, column 7 - line 124, column 20: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof InputFundAmount) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $78.fundAmountWei = Network_Eth.mkWei(v.value0);
                  return $78;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v instanceof FundId) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(Network_Eth_Foundation.depositWei(v.value0)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $86 = {};
                          for (var $87 in v1) {
          ...
          if (v instanceof CreateNewId) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(Network_Eth_Foundation.createId(Network_Eth_Foundation.fnMkName(v.value0))))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          throw new Error("Failed pattern match at Foundation.Manager line 96, column 10 - line 141, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
              ...
              return function (maybeBus) {
                  return function (mmInterval) {
                      return function (txInterval) {
                          ...
                          throw new Error("Failed pattern match at Foundation.Container line 246, column 3 - line 251, column 16: " + [ maybeBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var refreshMetamask = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.loggedIn))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.currentUserAddress))(function (v1) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
              ...
              $51.myAddr = new Data_Maybe.Just(v1);
              return $51;
          }))(function () {
              if (v) {
  ...
  var menuItem = function (screen) {
      return function (currentScreen) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("row " + (function () {
              var $62 = Data_Eq.eq(Foundation_Routes.eqScreen)(screen)(currentScreen);
              if ($62) {
                  return "active";
              };
              return "";
  ...
  var menu = function (currentScreen) {
      return function (myId) {
          ...
          throw new Error("Failed pattern match at Foundation.Container line 262, column 3 - line 277, column 10: " + [ myId.constructor.name ]);
      };
  };
                  ...
                  if (fError instanceof Network_Eth_Foundation.NoFoundationId) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Foundation_Prelude.hLog(dictMonadEff)(Network_Eth_Foundation.showError)(fError))(function () {
                          return Control_Monad_State_Class.modify(dictMonadState)(function (v) {
                              ...
                              $70.myId = Data_Maybe.Nothing.value;
                              return $70;
                          });
                      });
                  };
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
              ...
              if ($76) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_Maybe.Just.create)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.currentUserAddress)))(function (v3) {
                      var $78 = Data_Maybe.isNothing(v2) || Data_Eq.notEq(Data_Maybe.eqMaybe(Network_Eth.eqEthAddress))(v2)(v3);
                      if ($78) {
                          return refreshMetamask;
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
  ...
  var ui = (function () {
      var render = function (state) {
          ...
          })())))) ])([ promptMetamask(state.loggedIn), loadingOverlay(state.loading), topBar(state), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("body") ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Foundation_Manager.component)({
      ...
      var $$eval = function (v) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.delay(Data_Int.toNumber(1500))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(runTests(Halogen_Query_HalogenM.applicativeHalogenM))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleFCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(new Data_Maybe.Just(v1))(Data_Maybe.Nothing.value)(Network_Eth_Foundation.foundationId))(function (v2) {
          ...
          if (v instanceof HandleMsg) {
              ...
              if (v.value0 instanceof Foundation_Types.CheckTxs) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("checking Tx"))(function () {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          return v1.txs;
                      }))(function (v1) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Metamask.checkTxStatus)(v1))))(function (v3) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      var $102 = Foundation_Blockchain.hasNetworkError(v3);
                                      if ($102) {
                                          if (v2 instanceof Data_Maybe.Nothing) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          };
                                          ...
                                          throw new Error("Failed pattern match at Foundation.Container line 128, column 20 - line 130, column 63: " + [ v2.constructor.name ]);
                                      };
                                      var pending = Data_Array.filter(function (v4) {
                                          return Network_Eth.notDone(v4.value0);
                                      })(Data_Array.zip(v3)(v1));
                                      var $108 = Data_Array.length(pending) !== Data_Array.length(v1);
                                      if ($108) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                              ...
                                              $112.txs = Data_Functor.map(Data_Functor.functorArray)(function (v5) {
                                                  return v5.value1;
                                              })(pending);
                                              return $112;
                                          }))(function () {
              ...
              throw new Error("Failed pattern match at Foundation.Container line 111, column 9 - line 138, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $118.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.currentScreen ])(s.history);
                  return $118;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $121 = {};
          ...
          if (v instanceof MainViewMsg) {
              if (v.value0 instanceof Foundation_Manager.ScreenChange) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      var $127 = {};
                      for (var $128 in s) {
                          if ({}.hasOwnProperty.call(s, $128)) {
                              $127[$128] = s[$128];
                          };
                      };
                      $127.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.currentScreen ])(s.history);
                      return $127;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $130 = {};
                          ...
                          $130.currentScreen = v.value0.value0;
                          return $130;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
              ...
              if (v.value0 instanceof Foundation_Manager.NewTX) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $134.txs = Data_Semigroup.append(Data_Semigroup.semigroupArray)(s.txs)([ v.value0.value0 ]);
                      return $134;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              throw new Error("Failed pattern match at Foundation.Container line 147, column 9 - line 154, column 22: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof PreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $140.currentScreen = Data_Maybe.fromMaybe(Foundation_Routes.OverviewScreen.value)(Data_Array.head(state.history));
                  $140.history = Data_Maybe.fromMaybe([  ])(Data_Array.tail(state.history));
                  return $140;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Foundation.Container line 97, column 12 - line 157, column 18: " + [ v.constructor.name ]);
      };
