...
(function(exports) {
  ...
  var weiShowEth = function (v) {
      var dropZeros = function (s) {
          ...
          var $16 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqChar))(Data_Array.head(rev))(new Data_Maybe.Just("."));
          if ($16) {
  ...
  var showTX = new Data_Show.Show(function (v) {
      return "Transaction: " + Data_Show.show(showEthAddress)(v.value0);
  });
  ...
  var rawToTX = function (rawTx) {
      return TX.create(eaMkAddr(rawTx.txHash));
  };
  var blankTx = TX.create(eaMkAddr(""));
...
(function(exports) {
  ...
  var createId = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkAndInit)(function () {
          return Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(Network_Eth.rawToTX)(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (e) {
              return function (s) {
  ...
  var depositWei = function (w) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
          ...
          throw new Error("Failed pattern match at Network.Eth.Foundation line 201, column 3 - line 203, column 81: " + [ v.constructor.name ]);
      });
  };
  var expirationDate = (function () {
      ...
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
          ...
          throw new Error("Failed pattern match at Network.Eth.Foundation line 223, column 3 - line 227, column 32: " + [ v.constructor.name ]);
      });
  })();
  var getDepositWei = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 215, column 3 - line 218, column 69: " + [ v.constructor.name ]);
  });
  var sentPending = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 171, column 3 - line 175, column 93: " + [ v.constructor.name ]);
  });
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof AddNewAddress) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Foundation.Manager line 116, column 7 - line 120, column 20: " + [ v.value0.constructor.name ]);
              });
          };
          ...
          throw new Error("Failed pattern match at Foundation.Manager line 92, column 10 - line 139, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
          ...
          return function (dictMonadEff) {
              return function (maybeBus) {
                  return function (ms) {
                      ...
                      throw new Error("Failed pattern match at Foundation.Container line 161, column 3 - line 165, column 16: " + [ maybeBus.constructor.name ]);
                  };
              };
          };
      };
  ...
  var menu = function (currentScreen) {
      return function (myId) {
          ...
          throw new Error("Failed pattern match at Foundation.Container line 173, column 3 - line 188, column 10: " + [ myId.constructor.name ]);
      };
  };
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleMsg) {
              ...
              throw new Error("Failed pattern match at Foundation.Container line 107, column 9 - line 115, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Foundation.Container line 95, column 12 - line 125, column 18: " + [ v.constructor.name ]);
      };
