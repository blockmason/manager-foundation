...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main-view") ])([ page(Foundation_Routes.OverviewScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.OverviewScreen.value))), page(Foundation_Routes.ManageAddressesScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.ManageAddressesScreen.value))), page(Foundation_Routes.AddAddressScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.AddAddressScreen.value))), page(Foundation_Routes.RegisterScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.RegisterScreen.value))), page(Foundation_Routes.ExtendIDScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.ExtendIDScreen.value))), page(Foundation_Routes.FundIDScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.FundIDScreen.value))) ]);
      };
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Foundation.Manager line 53, column 10 - line 57, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
          ...
          return function (dictMonadEff) {
              return function (maybeBus) {
                  return function (ms) {
                      ...
                      throw new Error("Failed pattern match at Foundation.Container line 144, column 3 - line 148, column 16: " + [ maybeBus.constructor.name ]);
                  };
              };
          };
      };
  ...
  var menuItem = function (screen) {
      return function (currentScreen) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("col" + (function () {
  ...
  var menu = function (currentScreen) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("header-menu row") ])([ menuItem(Foundation_Routes.OverviewScreen.value)(currentScreen), menuItem(Foundation_Routes.ManageAddressesScreen.value)(currentScreen), menuItem(Foundation_Routes.AddAddressScreen.value)(currentScreen), menuItem(Foundation_Routes.RegisterScreen.value)(currentScreen), menuItem(Foundation_Routes.ExtendIDScreen.value)(currentScreen), menuItem(Foundation_Routes.FundIDScreen.value)(currentScreen) ]);
  };
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("container"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("container-fluid " + state.currentScreen)) ])([ promptMetamask(state.loggedIn), loadingOverlay(state.loading), menu(state.currentScreen), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("body") ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Foundation_Manager.component)(state.errorBus)(Halogen_HTML_Events.input(SetScreen.create)) ]) ]);
      };
      var initialState = {
          loggedIn: true, 
          loading: true, 
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Foundation.Container line 77, column 12 - line 108, column 18: " + [ v.constructor.name ]);
      };
