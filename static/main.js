...
(function(exports) {
      ...
      return function (expiryDate) {
          return function (addressCount) {
              return function (balance) {
                  ...
                  throw new Error("Failed pattern match at Foundation.Manager line 111, column 3 - line 126, column 10: " + [ optionalID.constructor.name ]);
              };
          };
      };
  };
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main-view") ])([ page(Foundation_Routes.OverviewScreen.value)(summary(state.myId)(state.expiryDate)(Data_Array.length(state.addresses))(state.funds)), page(Foundation_Routes.ManageAddressesScreen.value)(addressesPage(state.addresses)(state.sentUnification)(state.todoUnification)), page(Foundation_Routes.AddAddressScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.AddAddressScreen.value))), page(Foundation_Routes.RegisterScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.RegisterScreen.value))), page(Foundation_Routes.ExtendIDScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.ExtendIDScreen.value))), page(Foundation_Routes.FundIDScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.FundIDScreen.value))) ]);
      };
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Foundation.Manager line 69, column 10 - line 78, column 16: " + [ v.constructor.name ]);
      };
