...
(function(exports) {
  ...
  var showError = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 58, column 3 - line 59, column 3: " + [ v.constructor.name ]);
  });
  var runMonadF = Control_Monad_Except_Trans.runExceptT;
  var fiGetAddrs = function (v) {
      return v.addrs;
  };
  var isValid = function ($65) {
      return !Data_Array["null"](fiGetAddrs($65));
  };
  var showFoundationId = new Data_Show.Show(function (v) {
      var v1 = isValid(v);
      if (v1) {
          return Data_Show.show(showFoundationName)(v.name) + (", " + Data_Show.show(Data_Show.showArray(showEthAddress))(v.addrs));
      };
      if (!v1) {
          return "NoValidFoundationId";
      };
      throw new Error("Failed pattern match at Network.Eth.Foundation line 82, column 28 - line 86, column 1: " + [ v1.constructor.name ]);
  });
  var fiBlankId = {
      name: "", 
      addrs: [  ]
  ...
  var foundationId = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(currentAddr)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(idByAddr(v))(function (v1) {
          var $56 = Data_Array["null"](fiGetAddrs(v1));
          if ($56) {
...
(function(exports) {
  ...
  var mockSentUnification = [ mockTim ];
                  ...
                  return Control_Bind.bind(dictBind)(Control_Monad_State_Class.get(dictMonadState))(function (v) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Monad_State_Class.modify(dictMonadState)(function (v1) {
                          ...
                          return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleFCall(dictBind)(dictMonadEff)(dictMonadAff)(v.errorBus)(Network_Eth_Foundation.fiBlankId)(Network_Eth_Foundation.foundationId))(function (v1) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Foundation_Prelude.hLog(dictMonadEff)(Network_Eth_Foundation.showFoundationId)(v1))(function () {
                                  return Control_Monad_State_Class.modify(dictMonadState)(function (v2) {
                                      var $18 = {};
                                      for (var $19 in v2) {
                                      ...
                                      $18.myId = new Data_Maybe.Just(v1);
                                      $18.loading = false;
                                      return $18;
                                  });
                              });
      ...
      return function (expiryDate) {
          return function (addressCount) {
              return function (balance) {
                  ...
                  throw new Error("Failed pattern match at Foundation.Manager line 145, column 3 - line 160, column 10: " + [ optionalID.constructor.name ]);
              };
          };
      };
  };
  ...
  var addressesPage = function (addresses) {
      return function (pendingUnifications) {
          return function (todoUnifications) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col address-list") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ card("")(Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GoToPage.create(Foundation_Routes.AddAddressScreen.value))), Halogen_HTML_Properties.class_("confirm-address-button") ])([ Halogen_HTML_Core.text("Add Address") ])) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(function (v) {
                  return card("Waiting for confirmation from:")(Halogen_HTML_Core.text(Data_Show.show(Data_Show.showArray(Network_Eth_Foundation.showEthAddress))(v.addrs)));
              })(pendingUnifications))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(function (name) {
                  return card("Combine address request:")(addAddressRequestBlock(name));
              })(todoUnifications))(Data_Functor.map(Data_Functor.functorArray)(function (address) {
  ...
  var addAddressPage = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col add-address-page") ])([ card("Add new address")(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.value(""), Halogen_HTML_Properties.class_("row"), Halogen_HTML_Properties.placeholder("0x0"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
          return InputNewAddress.create(val);
      })) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddNewAddress.create(state.newAddress))), Halogen_HTML_Properties.class_("btn btn-secondary") ])([ Halogen_HTML_Core.text("Add Address") ]) ])) ]);
  };
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof InputNewAddress) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $34 = Data_String.length(v.value0) > 41;
                  if ($34) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $35.newAddress = Data_Either.Right.create(v.value0);
                          return $35;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $38.newAddress = new Data_Either.Left(v.value0);
                      return $38;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
          ...
          throw new Error("Failed pattern match at Foundation.Manager line 83, column 10 - line 111, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
          ...
          return function (dictMonadEff) {
              return function (maybeBus) {
                  return function (ms) {
                      ...
                      throw new Error("Failed pattern match at Foundation.Container line 157, column 3 - line 161, column 16: " + [ maybeBus.constructor.name ]);
                  };
              };
          };
      };
  ...
  var runTests = function (dictBind) {
      return function (dictMonadAff) {
          return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_Foundation.runMonadF(Network_Eth_Foundation.currentAddr)))(Foundation_Prelude.hLog(dictMonadAff.MonadEff0())(Data_Either.showEither(Network_Eth_Foundation.showError)(Network_Eth_Foundation.showEthAddress))))(function () {
              return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_Foundation.runMonadF(Network_Eth_Foundation.foundationId)))(Foundation_Prelude.hLog(dictMonadAff.MonadEff0())(Data_Either.showEither(Network_Eth_Foundation.showError)(Network_Eth_Foundation.showFoundationId)));
          });
      };
  };
  ...
  var menu = function (currentScreen) {
      return function (myId) {
          ...
          throw new Error("Failed pattern match at Foundation.Container line 169, column 3 - line 184, column 10: " + [ myId.constructor.name ]);
      };
  };
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleMsg) {
              ...
              throw new Error("Failed pattern match at Foundation.Container line 103, column 9 - line 111, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          throw new Error("Failed pattern match at Foundation.Container line 90, column 12 - line 121, column 18: " + [ v.constructor.name ]);
      };
