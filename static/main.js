...
(function(exports) {
  ...
  var mkWei = function ($93) {
      return Wei(Data_Int.round($93));
  };
  ...
  var fiStrName = function ($94) {
      return fnGetName(fiGetName($94));
  };
  ...
  var foundationId = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(currentAddr)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(idByAddr(v))(function (v1) {
          var $70 = Data_Array["null"](fiGetAddrs(v1));
          if ($70) {
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Aff.monadAff))(Data_Maybe.Nothing.value);
          };
          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Aff.monadAff))(new Data_Maybe.Just(v1));
  ...
  var expirationDate = (function () {
      ...
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
          ...
          throw new Error("Failed pattern match at Network.Eth.Foundation line 243, column 3 - line 247, column 32: " + [ v.constructor.name ]);
      });
  })();
  var getDepositWei = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      if (v instanceof Data_Maybe.Just) {
          return Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(function ($96) {
              return Data_Maybe.Just.create(mkWei($96));
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 235, column 3 - line 238, column 69: " + [ v.constructor.name ]);
  });
  var sentPending = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 191, column 3 - line 195, column 87: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var formatDate = function ($76) {
      return Data_Either.either(Data_Function["const"](""))(Control_Category.id(Control_Category.categoryFn))(Data_Formatter_DateTime.formatDateTime("YYYY-MM-DD")($76));
  };
  ...
  var fundsPage = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col funds-page") ])([ card("Balance")(Halogen_HTML_Core.text(Data_Show.show(Data_Maybe.showMaybe(Network_Eth_Foundation.showWei))(state.funds) + " Wei")), card("Deposit")(Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(FundId.create)), Halogen_HTML_Properties.class_("btn btn-secondary") ])([ Halogen_HTML_Core.text("Deposit ETH") ])) ]);
  };
  var summary = function (optionalID) {
      return function (expiryDate) {
          return function (addressCount) {
              return function (funds) {
                  var balance = Data_Maybe.fromMaybe(Network_Eth_Foundation.mkWei(0.0))(funds);
                  ...
                  if (optionalID instanceof Data_Maybe.Just) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col myid-summary") ])([ card("ID")(Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showFoundationName)(optionalID.value0.name))), card("Expires")(Halogen_HTML_Core.text(Data_Maybe.maybe("")(formatDate)(expiryDate))), card("Addresses")(Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(addressCount) + " associated")), card("Current Deposit")(Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showWei)(balance) + " Wei")) ]);
                  };
                  throw new Error("Failed pattern match at Foundation.Manager line 158, column 6 - line 173, column 10: " + [ optionalID.constructor.name ]);
              };
          };
      };
  };
  ...
  var addAddressPage = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col add-address-page") ])([ card("Link a new address to " + Data_Maybe.maybe("")(function ($77) {
          return Data_Show.show(Network_Eth_Foundation.showFoundationName)(Network_Eth_Foundation.fiGetName($77));
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof AddNewAddress) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  throw new Error("Failed pattern match at Foundation.Manager line 109, column 7 - line 113, column 20: " + [ v.value0.constructor.name ]);
              });
          };
          ...
          throw new Error("Failed pattern match at Foundation.Manager line 85, column 10 - line 122, column 16: " + [ v.constructor.name ]);
      };
