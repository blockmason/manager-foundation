...
(function(exports) {
  ...
  var showError = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 43, column 3 - line 44, column 3: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Address") ]);
      };
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Foundation.Address line 41, column 10 - line 45, column 12: " + [ v.constructor.name ]);
      };
  ...
  exports["component"] = component;
})(PS["Foundation.Address"] = PS["Foundation.Address"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Applicative = PS["Control.Applicative"];
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Data_Void = PS["Data.Void"];
  var Foundation_Address = PS["Foundation.Address"];
  var Foundation_Prelude = PS["Foundation.Prelude"];
  var Halogen = PS["Halogen"];
  var Halogen_Component = PS["Halogen.Component"];
  var Halogen_Component_ChildPath = PS["Halogen.Component.ChildPath"];
          ...
          return function (dictMonadEff) {
              return function (maybeBus) {
                  return function (ms) {
                      ...
                      throw new Error("Failed pattern match at Foundation.Container line 135, column 3 - line 139, column 16: " + [ maybeBus.constructor.name ]);
                  };
              };
          };
      };
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("container") ])([ promptMetamask(state.loggedIn), loadingOverlay(state.loading), Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("FoundationID Manager") ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row"), Halogen_HTML_Properties.id_("container") ])([ Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text("Container"), Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Foundation_Address.component)(state.errorBus)(Data_Void.absurd) ]) ]) ]);
      };
      var initialState = {
          loggedIn: true, 
          loading: true, 
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Foundation.Container line 74, column 12 - line 100, column 18: " + [ v.constructor.name ]);
      };
