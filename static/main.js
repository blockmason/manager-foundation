...
(function(exports) {
  ...
  var printTransaction = $foreign.printTransactionImpl(Data_Unit.unit);
  ...
  var loggedIn = function __do() {
      ...
      throw new Error("Failed pattern match at Network.Eth.Metamask line 40, column 3 - line 42, column 26: " + [ v.constructor.name ]);
  };
...
(function(exports) {
  ...
  var weiShowEth = function (v) {
      var dropZeros = function (s) {
          ...
          var $45 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqChar))(Data_Array.head(rev))(new Data_Maybe.Just("."));
          if ($45) {
  ...
  var foundationId = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(currentAddr)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(idByAddr(v))(function (v1) {
          var $79 = Data_Array["null"](fiGetAddrs(v1));
          if ($79) {
              return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Aff.monadAff))(Data_Maybe.Nothing.value);
          };
          return Control_Applicative.pure(Control_Monad_Except_Trans.applicativeExceptT(Control_Monad_Aff.monadAff))(new Data_Maybe.Just(v1));
  ...
  var depositWei = function (w) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
              return Control_Monad_Eff_Class.liftEff(Control_Monad_Except_Trans.monadEffExceptT(Control_Monad_Aff.monadEffAff))($foreign.depositWeiImpl(fnGetName(fiGetName(v.value0)))(weiStr(w)));
          };
          throw new Error("Failed pattern match at Network.Eth.Foundation line 245, column 3 - line 247, column 79: " + [ v.constructor.name ]);
      });
  };
  var expirationDate = (function () {
      ...
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
          ...
          throw new Error("Failed pattern match at Network.Eth.Foundation line 267, column 3 - line 271, column 32: " + [ v.constructor.name ]);
      });
  })();
  var getDepositWei = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      if (v instanceof Data_Maybe.Just) {
          return Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(function ($104) {
              return Data_Maybe.Just.create(mkWei($104));
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 259, column 3 - line 262, column 69: " + [ v.constructor.name ]);
  });
  var sentPending = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 215, column 3 - line 219, column 87: " + [ v.constructor.name ]);
  });
...
(function(exports) {
  ...
  var fundsPage = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col funds-page") ])([ card("Balance")(Halogen_HTML_Core.text(Data_Maybe.maybe("")(Data_Show.show(Network_Eth_Foundation.showWei))(state.funds) + " Wei")), card("Deposit")(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.class_("row"), Halogen_HTML_Properties.placeholder("Enter wei to deposit here"), Halogen_HTML_Properties.value(Network_Eth_Foundation.weiStr(state.fundAmountWei)), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
      ...
      return function (expiryDate) {
          return function (addressCount) {
              return function (funds) {
                  var balance = Data_Maybe.fromMaybe(Network_Eth_Foundation.zeroWei)(funds);
  ...
  var component = (function () {
      ...
      var initialState = function (input) {
          return {
              ...
              newName: "", 
              fundAmountWei: Network_Eth_Foundation.zeroWei
          };
      };
      var $$eval = function (v) {
          ...
          if (v instanceof InputFundAmount) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $73.fundAmountWei = Network_Eth_Foundation.mkWei(v.value0);
                  return $73;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
...
(function(exports) {
  ...
  var runTests = function (dictBind) {
      return function (dictMonadEff) {
          return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Monad_Eff_Class.liftEff(dictMonadEff)(Network_Eth_Metamask.printTransaction))(function () {
  ...
  var menuItem = function (screen) {
      return function (currentScreen) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("row " + (function () {
              var $33 = Data_Eq.eq(Foundation_Routes.eqScreen)(screen)(currentScreen);
              if ($33) {
                  return "active";
              };
              return "";
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $40.loggedIn = true;
                          $40.loading = true;
                          $40.errorBus = new Data_Maybe.Just(v1);
                          return $40;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.delay(Data_Int.toNumber(1500))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(runTests(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff)))(function () {
