...
(function(exports) {
  ...
  var getRouteNameFor = function (screen) {
      ...
      throw new Error("Failed pattern match at Foundation.Routes line 15, column 3 - line 29, column 1: " + [ screen.constructor.name ]);
  };
  var getMenuNameFor = function (screen) {
      ...
      throw new Error("Failed pattern match at Foundation.Routes line 47, column 3 - line 59, column 7: " + [ screen.constructor.name ]);
  };
  var getContainerNameFor = function (screen) {
      ...
      throw new Error("Failed pattern match at Foundation.Routes line 31, column 3 - line 45, column 1: " + [ screen.constructor.name ]);
  };
...
(function(exports) {
      ...
      return function (expiryDate) {
          return function (addressCount) {
              return function (balance) {
                  ...
                  throw new Error("Failed pattern match at Foundation.Manager line 94, column 3 - line 109, column 10: " + [ optionalID.constructor.name ]);
              };
          };
      };
  };
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main-view") ])([ page(Foundation_Routes.OverviewScreen.value)(summary(state.myId)(state.expiryDate)(Data_Array.length(state.addresses))(state.funds)), page(Foundation_Routes.ManageAddressesScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.ManageAddressesScreen.value))), page(Foundation_Routes.AddAddressScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.AddAddressScreen.value))), page(Foundation_Routes.RegisterScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.RegisterScreen.value))), page(Foundation_Routes.ExtendIDScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.ExtendIDScreen.value))), page(Foundation_Routes.FundIDScreen.value)(Halogen_HTML_Core.text(Foundation_Routes.getContainerNameFor(Foundation_Routes.FundIDScreen.value))) ]);
      };
      ...
      var $$eval = function (v) {
          ...
          throw new Error("Failed pattern match at Foundation.Manager line 67, column 10 - line 71, column 16: " + [ v.constructor.name ]);
      };
...
(function(exports) {
          ...
          return function (dictMonadEff) {
              return function (maybeBus) {
                  return function (ms) {
                      ...
                      throw new Error("Failed pattern match at Foundation.Container line 155, column 3 - line 159, column 16: " + [ maybeBus.constructor.name ]);
                  };
              };
          };
      };
  ...
  var menuItem = function (screen) {
      return function (currentScreen) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("row " + (function () {
              var $32 = currentScreen === Foundation_Routes.getRouteNameFor(screen);
              if ($32) {
                  return "active";
              };
              return "";
          })())), Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(SetScreen.create(Foundation_Routes.getRouteNameFor(screen)))) ])([ Halogen_HTML_Core.text(Foundation_Routes.getMenuNameFor(screen)) ]);
      };
  };
  var menu = function (currentScreen) {
      return function (myId) {
          ...
          throw new Error("Failed pattern match at Foundation.Container line 167, column 3 - line 182, column 10: " + [ myId.constructor.name ]);
      };
  };
  ...
  var ui = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof HandleMsg) {
              ...
              throw new Error("Failed pattern match at Foundation.Container line 101, column 9 - line 109, column 22: " + [ v.value0.constructor.name ]);
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $55.previousScreen = state.currentScreen;
                  return $55;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $58 = {};
          ...
          if (v instanceof ShowPreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $63.currentScreen = state.previousScreen;
                  return $63;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Foundation.Container line 88, column 12 - line 119, column 18: " + [ v.constructor.name ]);
      };
