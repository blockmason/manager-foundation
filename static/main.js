...
(function(exports) {
  ...
  var currentUserAddress = $foreign.currentUserImpl(Data_Unit.unit);
...
(function(exports) {
  ...
  var currentAddr = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkMM)(function () {
      return Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(Network_Eth.EthAddress)(Control_Monad_Eff_Class.liftEff(Control_Monad_Except_Trans.monadEffExceptT(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.currentUserAddress));
  });
...
<<<<<<< HEAD
                          throw new Error("Failed pattern match at Foundation.Container line 214, column 3 - line 219, column 16: " + [ maybeBus.constructor.name ]);
=======
                          throw new Error("Failed pattern match at Foundation.Container line 234, column 3 - line 239, column 16: " + [ maybeBus.constructor.name ]);
>>>>>>> redo styling to match fid v3
                      };
                  };
              };
          };
  ...
  var menuItem = function (screen) {
      return function (currentScreen) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("row " + (function () {
              var $53 = Data_Eq.eq(Foundation_Routes.eqScreen)(screen)(currentScreen);
              if ($53) {
                  return "active";
              };
              return "";
...
<<<<<<< HEAD
          throw new Error("Failed pattern match at Foundation.Container line 230, column 3 - line 245, column 10: " + [ myId.constructor.name ]);
=======
          throw new Error("Failed pattern match at Foundation.Container line 250, column 3 - line 265, column 10: " + [ myId.constructor.name ]);
>>>>>>> redo styling to match fid v3
      };
  };
                  ...
                  if (fError instanceof Network_Eth_Foundation.NoFoundationId) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Foundation_Prelude.hLog(dictMonadEff)(Network_Eth_Foundation.showError)(fError))(function () {
                          return Control_Monad_State_Class.modify(dictMonadState)(function (v) {
                              ...
                              $61.myId = Data_Maybe.Nothing.value;
                              return $61;
                          });
                      });
                  };
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.make))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $69.loggedIn = true;
                          $69.loading = true;
                          $69.errorBus = new Data_Maybe.Just(v1);
                          return $69;
                      }))(function () {
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Metamask.checkTxStatus)(v1))))(function (v3) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      var $90 = Foundation_Blockchain.hasNetworkError(v3);
                                      if ($90) {
                                          if (v2 instanceof Data_Maybe.Nothing) {
                                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                          };
...
<<<<<<< HEAD
                                          throw new Error("Failed pattern match at Foundation.Container line 133, column 20 - line 135, column 63: " + [ v2.constructor.name ]);
=======
...
<<<<<<< HEAD
              throw new Error("Failed pattern match at Foundation.Container line 114, column 9 - line 143, column 22: " + [ v.value0.constructor.name ]);
=======
              throw new Error("Failed pattern match at Foundation.Container line 108, column 9 - line 137, column 22: " + [ v.value0.constructor.name ]);
>>>>>>> redo styling to match fid v3
          };
          ...
          if (v instanceof SetScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $106.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.currentScreen ])(s.history);
                  return $106;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      var $109 = {};
          ...
          if (v instanceof MainViewMsg) {
              if (v.value0 instanceof Foundation_Manager.ScreenChange) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      ...
                      $115.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.currentScreen ])(s.history);
                      return $115;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $118 = {};
...
<<<<<<< HEAD
              throw new Error("Failed pattern match at Foundation.Container line 152, column 9 - line 159, column 22: " + [ v.value0.constructor.name ]);
=======
...
>>>>>>> redo styling to match fid v3
          ...
          if (v instanceof PreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $128.currentScreen = Data_Maybe.fromMaybe(Foundation_Routes.OverviewScreen.value)(Data_Array.head(state.history));
                  $128.history = Data_Maybe.fromMaybe([  ])(Data_Array.tail(state.history));
                  return $128;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
...
<<<<<<< HEAD
          throw new Error("Failed pattern match at Foundation.Container line 100, column 12 - line 162, column 18: " + [ v.constructor.name ]);
=======
          throw new Error("Failed pattern match at Foundation.Container line 94, column 12 - line 156, column 18: " + [ v.constructor.name ]);
>>>>>>> redo styling to match fid v3
      };
