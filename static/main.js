...
(function(exports) {
  ...
  var zeroWei = "0";
  var weiStr = function (v) {
      return v;
  };
  var weiShowEth = function (v) {
      var dropZeros = function (s) {
          var rev = Data_Array.dropWhile(function (c) {
              return c === "0";
          })(Data_Array.reverse(Data_String.toCharArray(s)));
          var $23 = Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqChar))(Data_Array.head(rev))(new Data_Maybe.Just("."));
          if ($23) {
              return Data_String.fromCharArray(Data_Array.reverse(Data_Array.drop(1)(rev)));
          };
          return Data_String.fromCharArray(Data_Array.reverse(rev));
      };
      var len = Data_String.length(v);
      var $24 = len > 18;
      if ($24) {
          return dropZeros(Data_String.take(len - 18 | 0)(v) + ("." + Data_String.drop(len - 18 | 0)(v)));
      };
      return dropZeros("0." + (Data_String.fromCharArray(Data_Array.replicate(18 - len | 0)("0")) + v));
  };
  ...
  var mkWei = function (v) {
      if (v === "") {
          return "0";
      };
      var isInt = function (v1) {
          if (v1 === "") {
              return true;
          };
          return Data_Maybe.isJust(Data_Int.fromString(Data_String.take(9)(v1))) && isInt(Data_String.drop(9)(v1));
      };
      var $38 = isInt(v);
      if ($38) {
          return v;
  ...
  exports["txStr"] = txStr;
  exports["weiShowEth"] = weiShowEth;
  exports["weiStr"] = weiStr;
  exports["zeroWei"] = zeroWei;
...
(function(exports) {
  ...
  var showError = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 77, column 3 - line 78, column 3: " + [ v.constructor.name ]);
  });
  ...
  var getWeiToExtend = Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(Network_Eth.mkWei)(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v) {
      return function (s) {
          return $foreign.getWeiToExtendImpl(s);
      };
  })));
  ...
  var fiStrName = function ($98) {
      return fnGetName(fiGetName($98));
  };
  var fiGetAddrs = function (v) {
      return v.addrs;
  };
  var isValid = function ($99) {
      return !Data_Array["null"](fiGetAddrs($99));
  };
  var checkMM = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Eff_Class.liftEff(Control_Monad_Except_Trans.monadEffExceptT(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.loggedIn))(function (v) {
      if (v) {
  ...
  var confirmPendingUnification = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkMM)(function () {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v1) {
              return function (s) {
                  return $foreign.confirmPendingUnificationImpl(s)(v);
              };
          })))(function (v1) {
              return Network_Eth.rawToTX(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Aff.monadAff))(TxError.value)(v1);
          });
      });
  };
  var currentAddr = Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkMM)(function () {
      return Control_Monad_Eff_Class.liftEff(Control_Monad_Except_Trans.monadEffExceptT(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.currentUserAddress);
  });
  var todoPending = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(currentAddr)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (e) {
          return function (s) {
              return $foreign.todoPendingImpl(s)(Network_Eth.getEa(v));
          };
      })))(function (v1) {
          var $59 = v1 === "";
          if ($59) {
  ...
  var deleteAddr = function (v) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkMM)(function () {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v1) {
              return function (s) {
                  return $foreign.deleteAddrImpl(s)(v);
              };
          })))(function (v1) {
              return Network_Eth.rawToTX(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Aff.monadAff))(TxError.value)(v1);
          });
  ...
  var depositWei = function (w) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
          ...
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v1) {
                  return function (s) {
                      return $foreign.depositWeiImpl(s)(fnGetName(fiGetName(v.value0)))(Network_Eth.weiStr(w));
                  };
  ...
  var extendIdOneYear = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(Network_Eth.weiStr)(getWeiToExtend))(function (v1) {
          if (v instanceof Data_Maybe.Nothing) {
              return Control_Monad_Error_Class.throwError(Control_Monad_Except_Trans.monadThrowExceptT(Control_Monad_Aff.monadAff))(NoFoundationId.value);
          };
          if (v instanceof Data_Maybe.Just) {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v2) {
                  return function (s) {
                      return $foreign.extendIdOneYearImpl(s)(fiStrName(v.value0))(v1);
                  };
              })))(function (v2) {
  ...
  var getDepositWei = Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(foundationId)(function (v) {
      ...
      if (v instanceof Data_Maybe.Just) {
          return Data_Functor.map(Control_Monad_Except_Trans.functorExceptT(Control_Monad_Aff.functorAff))(function ($100) {
              return Data_Maybe.Just.create(Network_Eth.mkWei($100));
          })(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v1) {
              return function (s) {
  ...
  var isFreshNameAndUser = function (fn) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(currentAddr)(isFreshAddr))(function () {
  ...
  var createId = function (fn) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(isFreshNameAndUser(fn))(function () {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (e) {
              return function (s) {
  ...
  var withdrawDeposit = function (w) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkMM)(function () {
          return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v) {
              return function (s) {
                  return $foreign.withdrawDepositImpl(s)(Network_Eth.weiStr(w));
              };
          })))(function (v) {
              return Network_Eth.rawToTX(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Aff.monadAff))(TxError.value)(v);
          });
      });
  };
  var addPendingUnification = function (ea) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(checkMM)(function () {
          return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(isFreshAddr(ea))(function () {
              return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Aff.monadAff))(Control_Monad_Aff_Class.liftAff(Control_Monad_Aff_Class.monadAffExceptT(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff.makeAff(function (v) {
                  return function (s) {
                      return $foreign.addPendingUnificationImpl(s)(Network_Eth.getEa(ea));
                  };
              })))(function (v) {
                  return Network_Eth.rawToTX(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Aff.monadAff))(TxError.value)(v);
              });
...
(function(exports) {
  ...
  var FoundationError = (function () {
      function FoundationError(value0) {
          this.value0 = value0;
      };
      FoundationError.create = function (value0) {
          return new FoundationError(value0);
      };
  ...
  var showContainerMsg = new Data_Show.Show(function (v) {
      if (v instanceof FoundationError) {
          return "FoundationError: " + Data_Show.show(Network_Eth_Foundation.showError)(v.value0);
      };
      ...
      throw new Error("Failed pattern match at Foundation.Types line 27, column 3 - line 27, column 60: " + [ v.constructor.name ]);
  });
                          ...
                          return function (affCall) {
                              ...
                              if (errorBus instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Network_Eth_Foundation.runMonadF(affCall)))(function (v) {
                                      if (v instanceof Data_Either.Left) {
                                          return Control_Bind.bind(dictBind)(Control_Monad_Aff_Class.liftAff(dictMonadAff)(Control_Monad_Aff_Bus.write(errorConstructor(v.value0))(errorBus.value0)))(function (v1) {
                                              return Control_Applicative.pure((dictMonadEff.Monad0()).Applicative0())(blankVal);
                                          });
                                      };
                                      if (v instanceof Data_Either.Right) {
                                      ...
                                      throw new Error("Failed pattern match at Foundation.Blockchain line 25, column 7 - line 28, column 30: " + [ v.constructor.name ]);
                                  });
                              };
                              throw new Error("Failed pattern match at Foundation.Blockchain line 19, column 3 - line 28, column 30: " + [ errorBus.constructor.name ]);
                          };
                      };
                  };
              };
                  ...
                  return function (homeScreenQuery) {
                      return function (errorConstructor) {
                          return function (fnToRun) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(dictMonadEff))(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(state.errorBus)(Network_Eth.blankTx)(errorConstructor)(fnToRun))(function (v) {
...
})(PS["Foundation.Config"] = PS["Foundation.Config"] || {});
(function(exports) {
  // Generated by purs version 0.11.4
  "use strict";
  var Control_Semigroupoid = PS["Control.Semigroupoid"];
...
(function(exports) {
  ...
  var InputFundAmount = (function () {
      function InputFundAmount(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      InputFundAmount.create = function (value0) {
          return function (value1) {
              return new InputFundAmount(value0, value1);
          };
      };
      return InputFundAmount;
  })();
  var FundId = (function () {
      function FundId(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      FundId.create = function (value0) {
          return function (value1) {
              return new FundId(value0, value1);
          };
      };
      return FundId;
  })();
  var WithdrawDeposit = (function () {
      function WithdrawDeposit(value0) {
          this.value0 = value0;
      };
      WithdrawDeposit.create = function (value0) {
          return new WithdrawDeposit(value0);
      };
              ...
              return function (dictMonadAff) {
                  return function (myId) {
                      return Control_Bind.bind(dictBind)(Control_Monad_State_Class.gets(dictMonadState)(function (v) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Monad_Eff_Class.liftEff(dictMonadEff)(UI_UIStatesKit.toggleLoading(".main-view")))(function () {
                              return Control_Bind.bind(dictBind)(Control_Monad_Eff_Class.liftEff(dictMonadEff)(Network_Eth_Metamask.currentUserAddress))(function (v1) {
                                  return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Data_Maybe.Nothing.value)(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.sentPending))(function (v2) {
                                      return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Data_Maybe.Nothing.value)(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.todoPending))(function (v3) {
                                          return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Data_Maybe.Nothing.value)(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.expirationDate))(function (v4) {
                                              return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Data_Maybe.Nothing.value)(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.getDepositWei))(function (v5) {
                                                  return Control_Bind.bind(dictBind)(Foundation_Blockchain.handleCall(dictBind)(dictMonadEff)(dictMonadAff)(v)(Network_Eth.zeroWei)(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.getWeiToExtend))(function (v6) {
                                                      var addrs = Data_Maybe.maybe([  ])(Network_Eth_Foundation.fiGetAddrs)(myId);
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Control_Monad_State_Class.modify(dictMonadState)(function (v7) {
                                                          var $37 = {};
                                                          for (var $38 in v7) {
                                                              if ({}.hasOwnProperty.call(v7, $38)) {
                                                                  $37[$38] = v7[$38];
                                                              };
                                                          };
                                                          $37.addresses = addrs;
                                                          $37.myAddress = new Data_Maybe.Just(v1);
                                                          $37.sentPending = v2;
                                                          $37.todoPending = v3;
                                                          $37.funds = v5;
                                                          $37.expiryDate = v4;
                                                          ...
                                                          return Control_Monad_Eff_Class.liftEff(dictMonadEff)(UI_UIStatesKit.toggleLoading(".main-view"));
                                                      });
                                                  });
                                              });
                                          });
  ...
  var createIdPage = function (state) {
      ...
      })) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(CreateNewId.create(state.newName))), Halogen_HTML_Properties.class_("btn btn-secondary create-id-button"), Halogen_HTML_Properties.enabled(Network_Eth_Foundation.fiStrValidId(state.newName)) ])([ Halogen_HTML_Core.text("Create Foundation ID") ]) ])) ]);
  };
  var displayAddressBlock = function (myAddr) {
      return function (address) {
          return card("Unified Address")(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("") ])([ Halogen_HTML_Core.text(Data_Show.show(Network_Eth.showEthAddress)(address)), (function () {
              var $41 = Data_Maybe.maybe(false)(function (a) {
                  return Data_Eq.eq(Network_Eth.eqEthAddress)(a)(address);
              })(myAddr);
              if ($41) {
                  return Halogen_HTML_Core.text("");
              };
              return Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(DeleteAddress.create(address))), Halogen_HTML_Properties.class_("delete-address-button") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-trash") ])([  ]) ]);
          })() ]));
      };
  };
          ...
          return function (sentPending) {
              return function (todoPending) {
                  ...
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col address-list") ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ card("")(Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(GoToPage.create(Foundation_Routes.AddAddressScreen.value))), Halogen_HTML_Properties.class_("confirm-address-button") ])([ Halogen_HTML_Core.text("Add Address") ])) ])(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Maybe.maybe([  ])(function (sp) {
                      return [ card("Waiting for confirmation from:")(Halogen_HTML_Core.text(Data_Show.show(Network_Eth.showEthAddress)(sp))) ];
                  ...
                  })(todoPending))(Data_Functor.map(Data_Functor.functorArray)(displayAddressBlock(myAddr))(addresses)))));
              };
          };
      };
  };
  var addAddressRequestBlock = function (name) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(ConfirmUnification.create(name))), Halogen_HTML_Properties.class_("confirm-unification-button") ])([ Halogen_HTML_Core.text("Combine with: " + Data_Show.show(Network_Eth_Foundation.showFoundationName)(name)) ]) ]);
  };
  var summary = function (pendingConfirmation) {
      return function (optionalID) {
          return function (expiryDate) {
              return function (addressCount) {
                  return function (funds) {
                      var balance = Data_Maybe.fromMaybe(Network_Eth.zeroWei)(funds);
                      if (optionalID instanceof Data_Maybe.Nothing) {
                          if (pendingConfirmation instanceof Data_Maybe.Nothing) {
                          ...
                          if (pendingConfirmation instanceof Data_Maybe.Just) {
                              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col myid-summary") ])([ card("Merge with existing id, or register.")(addAddressRequestBlock(pendingConfirmation.value0)) ]);
                          };
  ...
  var addAddressPage = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col add-address-page") ])([ card("Link a new address to " + Data_Maybe.maybe("")(function ($110) {
          return Data_Show.show(Network_Eth_Foundation.showFoundationName)(Network_Eth_Foundation.fiGetName($110));
      })(state.myId))(Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col") ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.type_(Halogen_HTML_Core.inputTypeIsProp)(DOM_HTML_Indexed_InputType.InputText.value), Halogen_HTML_Properties.value(""), Halogen_HTML_Properties.class_(""), Halogen_HTML_Properties.placeholder("0x0"), Halogen_HTML_Events.onValueInput(Halogen_HTML_Events.input(function (val) {
          return InputNewAddress.create(val);
      })) ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(AddNewAddress.create(state.newAddress))), Halogen_HTML_Properties.disabled(Data_Either.isLeft(state.newAddress)), Halogen_HTML_Properties.class_("btn btn-secondary add-address-button") ])([ Halogen_HTML_Core.text("Add Address") ]) ])) ]);
  };
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("main-view") ])([ page(Foundation_Routes.OverviewScreen.value)(summary(state.todoPending)(state.myId)(state.expiryDate)(Data_Array.length(state.addresses))(state.funds)), page(Foundation_Routes.ManageAddressesScreen.value)(addressesPage(state.myAddress)(state.addresses)(state.sentPending)(state.todoPending)), page(Foundation_Routes.AddAddressScreen.value)(addAddressPage(state)), page(Foundation_Routes.RegisterScreen.value)(createIdPage(state)), page(Foundation_Routes.ExtendIDScreen.value)(extendIdPage(state.expiryDate)(state.weiToExtend)) ]);
      };
      var initialState = function (input) {
          return {
              ...
              myId: input.myId, 
              myAddress: Data_Maybe.Nothing.value, 
              addresses: [  ], 
              sentPending: Data_Maybe.Nothing.value, 
              todoPending: Data_Maybe.Nothing.value, 
              expiryDate: Data_Maybe.Nothing.value, 
              funds: Data_Maybe.Nothing.value, 
              newAddress: new Data_Either.Left(""), 
              newName: "", 
              fundAmountWei: Network_Eth.zeroWei, 
              weiToExtend: Network_Eth.zeroWei
          };
      };
      var $$eval = function (v) {
          if (v instanceof HandleInput) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $47.errorBus = v.value0.msgBus;
                  $47.myId = v.value0.myId;
                  return $47;
              }))(function () {
          ...
          if (v instanceof GoToPage) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new ScreenChange(v.value0)))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          };
          if (v instanceof ConfirmUnification) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".confirm-unification-button")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(Foundation_Routes.OverviewScreen.value))(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.confirmPendingUnification(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".confirm-unification-button")))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          if (v instanceof InputNewAddress) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $60 = Data_String.length(v.value0) === 42;
                  if ($60) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $61.newAddress = Data_Either.Right.create(v.value0);
                          return $61;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $64.newAddress = new Data_Either.Left(v.value0);
                      return $64;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  ...
                  if (v.value0 instanceof Data_Either.Right) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $72.newAddress = new Data_Either.Left("");
                          return $72;
                      }))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".add-address-button")))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(Foundation_Routes.OverviewScreen.value))(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.addPendingUnification(v.value0.value0)))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".add-address-button")))(function () {
                                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                                  });
                              });
                  ...
                  throw new Error("Failed pattern match at Foundation.Manager line 129, column 7 - line 137, column 20: " + [ v.value0.constructor.name ]);
              });
          };
          if (v instanceof DeleteAddress) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".delete-address-button")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(Foundation_Routes.OverviewScreen.value))(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.deleteAddr(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".delete-address-button")))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          if (v instanceof ExtendId) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".extend-id-button")))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(Foundation_Routes.OverviewScreen.value))(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.extendIdOneYear))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".extend-id-button")))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                          });
                      });
          ...
          if (v instanceof InputFundAmount) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  var $83 = {};
                  for (var $84 in v1) {
                  ...
                  $83.fundAmountWei = Network_Eth.mkWei(v.value0);
                  return $83;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
              });
          ...
          if (v instanceof FundId) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".fund-id-button")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(Foundation_Routes.OverviewScreen.value))(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.depositWei(v.value0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".fund-id-button")))(function () {
                              return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                          });
                      });
          ...
          if (v instanceof WithdrawDeposit) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  if (v1.funds instanceof Data_Maybe.Just) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".withdraw-deposit-button")))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(Foundation_Routes.OverviewScreen.value))(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.withdrawDeposit(v1.funds.value0)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".withdraw-deposit-button")))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                              });
                          });
                  ...
                  if (v1.funds instanceof Data_Maybe.Nothing) {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
                  };
                  throw new Error("Failed pattern match at Foundation.Manager line 164, column 7 - line 171, column 28: " + [ v1.funds.constructor.name ]);
              });
          };
          if (v instanceof InputNewName) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $95 = Network_Eth_Foundation.fiStrValidId(Data_String.toLower(v.value0)) || Data_String.length(v.value0) < 4;
                  if ($95) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $96 = {};
                          for (var $97 in v1) {
                          ...
                          $96.newName = Data_String.toLower(v.value0);
                          return $96;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          if (v instanceof CreateNewId) {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (v1) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".create-id-button")))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleTx(Control_Monad_Aff.monadEffAff)(Control_Monad_Aff_Class.monadAffAff)(NewTX.create)(v1)(new ScreenChange(Foundation_Routes.OverviewScreen.value))(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.createId(Network_Eth_Foundation.fnMkName(v.value0))))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.toggleLoading(".create-id-button")))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                              });
                          });
          ...
          throw new Error("Failed pattern match at Foundation.Manager line 101, column 10 - line 184, column 16: " + [ v.constructor.name ]);
      };
  ...
  exports["InputFundAmount"] = InputFundAmount;
  ...
  exports["displayAddressBlock"] = displayAddressBlock;
...
(function(exports) {
  ...
  var Data_Unit = PS["Data.Unit"];
  var Foundation_Blockchain = PS["Foundation.Blockchain"];
  var Foundation_Config = PS["Foundation.Config"];
  ...
  var MainViewMsg = (function () {
      function MainViewMsg(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      MainViewMsg.create = function (value0) {
          return function (value1) {
              return new MainViewMsg(value0, value1);
          };
      };
      return MainViewMsg;
  })();
                  ...
                  return function (mmInterval) {
                      return function (txInterval) {
                          var checkTxsEff = function (b) {
                              return function __do() {
                                  var v = Control_Monad_Aff.launchAff(Control_Monad_Aff_Bus.write(Foundation_Types.CheckTxs.value)(b))();
                                  return Data_Unit.unit;
                              };
                          };
                          var checkMMEff = function (b) {
                              return function __do() {
                                  var v = Control_Monad_Aff.launchAff(Control_Monad_Aff_Bus.write(Foundation_Types.CheckMetamask.value)(b))();
                                  return Data_Unit.unit;
                              };
                          };
                          ...
                          throw new Error("Failed pattern match at Foundation.Container line 271, column 3 - line 276, column 16: " + [ maybeBus.constructor.name ]);
                      };
                  };
              };
          };
  ...
  var refreshMetamask = Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("start refreshMM"))(function () {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.loggedIn))(function (v) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.currentUserAddress))(function (v1) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                  ...
                  $58.myAddr = new Data_Maybe.Just(v1);
                  return $58;
              }))(function () {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("got my address"))(function () {
                      if (v) {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v3) {
                                  ...
                                  $63.loggedIn = true;
                                  $63.errorToDisplay = Data_Maybe.Nothing.value;
                                  return $63;
                              }))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Blockchain.handleCall(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(v2)(Data_Maybe.Nothing.value)(Foundation_Types.FoundationError.create)(Network_Eth_Foundation.foundationId))(function (v3) {
                      ...
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          $70.loggedIn = false;
                          $70.errorToDisplay = new Data_Maybe.Just(Foundation_Types.NetworkError.value);
                          return $70;
                      });
                  });
              });
  ...
  var menuItem = function (screen) {
      return function (currentScreen) {
          return Halogen_HTML_Elements.a([ Halogen_HTML_Properties.href("#"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("row " + (function () {
              var $73 = Data_Eq.eq(Foundation_Routes.eqScreen)(screen)(currentScreen);
              if ($73) {
                  return "active";
              };
              return "";
  ...
  var menu = function (currentScreen) {
      return function (myId) {
          ...
          throw new Error("Failed pattern match at Foundation.Container line 287, column 3 - line 299, column 10: " + [ myId.constructor.name ]);
      };
  };
  var loadWeb3Loop = function (delayMs) {
      return function (numTriesLeft) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v) {
              ...
              if (v instanceof Data_Maybe.Just) {
                  var $78 = numTriesLeft > 0;
                  if ($78) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("About to try web3"))(function () {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.write(Foundation_Types.NetworkError.value)(v.value0)))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  });
              };
              throw new Error("Failed pattern match at Foundation.Container line 319, column 3 - line 332, column 14: " + [ v.constructor.name ]);
          });
      };
  };
  var handleFoundationError = function (dictBind) {
      return function (dictMonadEff) {
          return function (dictMonadState) {
              return function (fError) {
                  if (fError instanceof Network_Eth_Foundation.NoMetamask) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Foundation_Prelude.hLog(dictMonadEff)(Network_Eth_Foundation.showError)(fError))(function () {
                  ...
                  if (fError instanceof Network_Eth_Foundation.NoFoundationId) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(dictBind)(Foundation_Prelude.hLog(dictMonadEff)(Network_Eth_Foundation.showError)(fError))(function () {
                          return Control_Monad_State_Class.modify(dictMonadState)(function (v) {
                              var $86 = {};
                              for (var $87 in v) {
                              ...
                              $86.myId = Data_Maybe.Nothing.value;
                              return $86;
                          });
                      });
                  };
                  if (fError instanceof Network_Eth_Foundation.TxError) {
                      return Foundation_Prelude.hLog(dictMonadEff)(Data_Show.showString)("Transaction not completed.");
                  };
                  if (fError instanceof Network_Eth_Foundation.NameInUse) {
                      return Foundation_Prelude.hLog(dictMonadEff)(Network_Eth_Foundation.showError)(fError);
                  };
                  if (fError instanceof Network_Eth_Foundation.AddrInUse) {
                      return Foundation_Prelude.hLog(dictMonadEff)(Network_Eth_Foundation.showError)(fError);
                  };
                  return Foundation_Prelude.hLog(dictMonadEff)(Network_Eth_Foundation.showError)(fError);
              };
  ...
  var errorOverlay = function (state) {
      ...
      if (state.errorToDisplay instanceof Data_Maybe.Just && state.errorToDisplay.value0 instanceof Foundation_Types.FoundationError) {
          if (state.errorToDisplay.value0.value0 instanceof Network_Eth_Foundation.NoMetamask) {
              return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("errorOverlay") ])([ Halogen_HTML_Elements.h6_([ Halogen_HTML_Core.text("No Metamask Detected") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(Halogen_HTML_Events.input_(RefreshMetamask.create)), Halogen_HTML_Properties.class_("error-action") ])([ Halogen_HTML_Elements.i([ Halogen_HTML_Properties.class_("fa fa-refresh") ])([  ]) ]) ]);
          };
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("no-errors") ])([  ]);
      };
      if (state.errorToDisplay instanceof Data_Maybe.Just) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("row error-notification") ])([ Halogen_HTML_Core.text(Data_Show.show(Foundation_Types.showContainerMsg)(state.errorToDisplay.value0)) ]);
      };
      throw new Error("Failed pattern match at Foundation.Container line 210, column 3 - line 235, column 36: " + [ state.errorToDisplay.constructor.name ]);
  };
  var checkMetamask = Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.loggedIn))(function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
              ...
              var $98 = v1 && v;
              if ($98) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor.map(Halogen_Query_HalogenM.functorHalogenM)(Data_Maybe.Just.create)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Network_Eth_Metamask.currentUserAddress)))(function (v3) {
                      var $100 = Data_Maybe.isNothing(v2) || Data_Eq.notEq(Data_Maybe.eqMaybe(Network_Eth.eqEthAddress))(v2)(v3);
                      if ($100) {
                          return refreshMetamask;
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
  ...
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("container"), Halogen_HTML_Properties.class_(Halogen_HTML_Core.ClassName("container " + (Foundation_Routes.getRouteNameFor(state.currentScreen) + (function () {
              var $101 = Data_Maybe.isNothing(state.myId);
              if ($101) {
                  return " require-foundation";
              };
              return "";
          })()))) ])([ errorOverlay(state), topBar(state), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.id_("body") ])([ Halogen_HTML["slot'"](Halogen_Component_ChildPath.cp1)(Data_Unit.unit)(Foundation_Manager.component)({
              msgBus: state.errorBus, 
              myId: state.myId
          })(Halogen_HTML_Events.input(MainViewMsg.create)) ]), menu(state.currentScreen)(state.myId) ]);
      };
      var initialState = {
          loggedIn: true, 
      ...
      var $$eval = function (v) {
          if (v instanceof Init) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("start of whole app "))(function () {
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Component_Utils.busEventSource(Control_Monad_Aff_Class.monadAffAff)(Data_Function.flip(HandleMsg.create)(Halogen_Query_EventSource.Listening.value))(v1)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Eff_Class.liftEff(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(UI_UIStatesKit.turnOnLoading(".container")))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("before load loop"))(function () {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(loadWeb3Loop(Foundation_Config.web3Delay)(10))(function () {
          ...
          if (v instanceof HandleMsg) {
              if (v.value0 instanceof Foundation_Types.FoundationError) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $109.errorToDisplay = new Data_Maybe.Just(v.value0);
                      return $109;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleFoundationError(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Halogen_Query_HalogenM.monadStateHalogenM)(v.value0.value0))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
                  });
              };
              if (v.value0 instanceof Foundation_Types.NetworkError) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Foundation_Types.showContainerMsg)(Foundation_Types.NetworkError.value))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $113 = {};
                          for (var $114 in v1) {
                          ...
                          $113.loggedIn = false;
                          $113.errorToDisplay = new Data_Maybe.Just(Foundation_Types.NetworkError.value);
                          return $113;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
              ...
              if (v.value0 instanceof Foundation_Types.CheckMetamask) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(checkMetamask)(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              if (v.value0 instanceof Foundation_Types.CheckTxs) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      return v1.txs;
                  }))(function (v1) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.gets(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Data_Traversable.sequence(Data_Traversable.traversableArray)(Control_Monad_Aff.applicativeAff)(Data_Functor.map(Data_Functor.functorArray)(Network_Eth_Metamask.checkTxStatus)(v1))))(function (v3) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  var $119 = Foundation_Blockchain.hasNetworkError(v3);
                                  if ($119) {
                                      if (v2 instanceof Data_Maybe.Nothing) {
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                      };
                                      if (v2 instanceof Data_Maybe.Just) {
                                          return Control_Monad_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Control_Monad_Aff_Class.monadAffAff))(Control_Monad_Aff_Bus.write(Foundation_Types.NetworkError.value)(v2.value0));
                                      };
                                      throw new Error("Failed pattern match at Foundation.Container line 127, column 20 - line 129, column 63: " + [ v2.constructor.name ]);
                                  };
                                  var pending = Data_Array.filter(function (v4) {
                                      return Network_Eth.notDone(v4.value0);
                                  })(Data_Array.zip(v3)(v1));
                                  var $125 = Data_Array.length(pending) !== Data_Array.length(v1);
                                  if ($125) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v4) {
                                          var $129 = {};
                                          for (var $130 in v4) {
                                          ...
                                          $129.txs = Data_Functor.map(Data_Functor.functorArray)(function (v5) {
                                              return v5.value1;
                                          })(pending);
                                          return $129;
                                      }))(function () {
                                          var $132 = Data_Array.length(pending) === 0;
                                          if ($132) {
                                              return refreshMetamask;
                                          };
                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              ...
              throw new Error("Failed pattern match at Foundation.Container line 110, column 9 - line 137, column 22: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof RefreshMetamask) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Foundation_Prelude.hLog(Halogen_Query_HalogenM.monadEffHalogenM(Control_Monad_Aff.monadEffAff))(Data_Show.showString)("RefreshMetamask"))(function () {
          ...
          if (v instanceof MainViewMsg) {
              if (v.value0 instanceof Foundation_Manager.ScreenChange) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      var $145 = {};
                      for (var $146 in s) {
                      ...
                      $145.history = Data_Semigroup.append(Data_Semigroup.semigroupArray)([ s.currentScreen ])(s.history);
                      return $145;
                  }))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          var $148 = {};
                          ...
                          $148.currentScreen = v.value0.value0;
                          return $148;
                      }))(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                      });
              ...
              if (v.value0 instanceof Foundation_Manager.NewTX) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                      var $152 = {};
                      for (var $153 in s) {
                      ...
                      $152.txs = Data_Semigroup.append(Data_Semigroup.semigroupArray)(s.txs)([ v.value0.value0 ]);
                      return $152;
                  }))(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
                  });
              };
              throw new Error("Failed pattern match at Foundation.Container line 148, column 9 - line 155, column 22: " + [ v.value0.constructor.name ]);
          };
          if (v instanceof PreviousScreen) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  $158.currentScreen = Data_Maybe.fromMaybe(Foundation_Routes.OverviewScreen.value)(Data_Array.head(state.history));
                  $158.history = Data_Maybe.fromMaybe([  ])(Data_Array.tail(state.history));
                  return $158;
              }))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value0);
              });
          };
          throw new Error("Failed pattern match at Foundation.Container line 97, column 12 - line 158, column 18: " + [ v.constructor.name ]);
      };
  ...
  exports["MainViewMsg"] = MainViewMsg;
  ...
  exports["handleFoundationError"] = handleFoundationError;
