          ...
          return function (addressCount) {
              return function (funds) {
                  ...
                  if (optionalID instanceof Data_Maybe.Just) {
                      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("col myid-summary") ])([ card("ID")(Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showFoundationName)(optionalID.value0.name))), card("Expires")(Halogen_HTML_Core.text(randomDate)), card("Addresses")(Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(addressCount) + " associated")), card("Current Deposit")(Halogen_HTML_Core.text(Data_Show.show(Network_Eth_Foundation.showWei)(balance) + " Wei")) ]);
                  };
                  throw new Error("Failed pattern match at Foundation.Manager line 156, column 6 - line 171, column 10: " + [ optionalID.constructor.name ]);
              };
          };
      };
  };
