  ...
  var component = (function () {
      ...
      var $$eval = function (v) {
          ...
          if (v instanceof ReloadAll) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(loadFromBlockchain(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.monadStateHalogenM))(function () {
          ...
          if (v instanceof InputNewAddress) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                  var $26 = Data_String.length(v.value0) > 41;
                  if ($26) {
                      return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                          ...
                          $27.newAddress = Data_Either.Right.create(v.value0);
                          return $27;
                      });
                  };
                  return Control_Monad_State_Class.modify(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                      ...
                      $30.newAddress = new Data_Either.Left(v.value0);
                      return $30;
                  });
              })())(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(v.value1);
