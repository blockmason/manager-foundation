...
(function(exports) {
  ...
  var getMenuNameFor = function (screen) {
      ...
      throw new Error("Failed pattern match at Foundation.Routes line 50, column 3 - line 62, column 7: " + [ screen.constructor.name ]);
  };
  var getContainerNameFor = function (screen) {
      if (screen instanceof OverviewScreen) {
          return "overview-screen-container";
      };
      if (screen instanceof ManageAddressesScreen) {
          return "manage-addresses-screen-container";
      };
      if (screen instanceof AddAddressScreen) {
          return "add-address-screen-container";
      };
      if (screen instanceof RegisterScreen) {
          return "register-screen-container";
      };
      if (screen instanceof ExtendIDScreen) {
          return "extend-id-screen-container";
      };
      if (screen instanceof FundIDScreen) {
          return "fund-id-screen-container";
      };
      throw new Error("Failed pattern match at Foundation.Routes line 34, column 3 - line 48, column 1: " + [ screen.constructor.name ]);
  };
...
(function(exports) {
  ...
  var showError = new Data_Show.Show(function (v) {
      ...
      throw new Error("Failed pattern match at Network.Eth.Foundation line 57, column 3 - line 58, column 3: " + [ v.constructor.name ]);
  });
